      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/50 text-sm mt-1">
            إدارة رصيد المستخدمين وسجل المعاملات
          </p>
        </div>
      </div>
            ...
            <tbody>
              {filtered.map((user: any) => (
                ...
                >
                  ...
                  <td className="p-3 text-sm text-white/50" dir="ltr">
                    {user.email || "-"}
                  </td>
                  <td className="p-3">
                    <span
                      className={`px-2 py-0.5 rounded-full text-xs ${user.role === "admin" ? "bg-[var(--theme-primary)]/10 text-[var(--theme-primary)]" : "bg-blue-500/10 text-blue-400"}`}
                    >
