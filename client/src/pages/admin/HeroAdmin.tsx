...
export default function HeroAdmin() {
  ...
  const { data: savedImages, isLoading: isLoadingImages } =
    trpc.siteSettings.get.useQuery(
  ...
  useEffect(() => {
    if (savedImages) {
      try {
        const p = JSON.parse(savedImages);
        if (Array.isArray(p) && p.length > 0) setHeroImages(p);
      } catch {}
    }
  }, [savedImages]);
  ...
  const markData = (data: HeroData) => {
    setHeroData(data);
    setHasChanges(true);
  };
  const markImages = (images: HeroImage[]) => {
  ...
  if (isLoadingData || isLoadingImages)
    return (
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-white/50 text-sm mt-1">
            تعديل صورة الخلفية والنصوص والأزرار في الواجهة الرئيسية
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    markData({ ...heroData, title: e.target.value })
                  }
              ...
              <div>
                <label className="block text-sm font-medium text-white mb-2">
                  الكلمات المتغيرة (Rotating Words)
                </label>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    markData({ ...heroData, subtitle: e.target.value })
                  }
                  className="bg-[#1a1a1a] border-white/10 text-white"
          ...
          {activeTab === "images" && (
            <div className="space-y-4">
              ...
              {heroImages.map((img) => (
                <div
                  key={img.id}
                  className="bg-[#1a1a1a] border border-white/5 rounded-lg p-4 space-y-3"
                >
                  <div className="flex items-center justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <Input
                        value={img.label}
                        onChange={(e) =>
                          updateImage(img.id, "label", e.target.value)
                        }
                    ...
                    <div>
                      ...
                      <Input
                        value={img.sublabel}
                        onChange={(e) =>
                          updateImage(img.id, "sublabel", e.target.value)
                        }
                        className="bg-[var(--theme-surface)] border-white/10 text-white text-sm h-8"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <Input
                      value={img.link}
                      onChange={(e) =>
                        updateImage(img.id, "link", e.target.value)
                      }
                      className="bg-[var(--theme-surface)] border-white/10 text-white text-sm h-8"
                    />
                  </div>
          ...
          {activeTab === "buttons" && (
            <div className="space-y-4">
              ...
              <div className="bg-[#1a1a1a] border border-white/5 rounded-lg p-4 space-y-3">
                <h4 className="text-sm font-medium text-[var(--theme-primary)]">
                  الزر الأول (رئيسي)
                </h4>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        markData({ ...heroData, buttonText1: e.target.value })
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        markData({ ...heroData, buttonLink1: e.target.value })
                      }
                      className="bg-[var(--theme-surface)] border-white/10 text-white text-sm"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        markData({ ...heroData, buttonText2: e.target.value })
                      }
                      className="bg-[var(--theme-surface)] border-white/10 text-white text-sm"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        markData({ ...heroData, buttonLink2: e.target.value })
                      }
                      className="bg-[var(--theme-surface)] border-white/10 text-white text-sm"
                    />
                  </div>
        ...
        <div className="bg-[var(--theme-surface)] border-white/5 rounded-lg p-4 lg:p-0 lg:bg-transparent lg:border-none">
          <div className="sticky top-24">
            ...
            <div className="aspect-[16/9] bg-black rounded-lg overflow-hidden border-2 border-[var(--theme-primary)]">
              ...
              <div
                className="w-full h-full bg-cover bg-center relative text-white flex flex-col justify-center items-center text-center p-8"
                style={{
                  backgroundImage: `url(${heroImages.find((img) => img.id === 1)?.url || "/placeholder.svg"})`,
                }}
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-8 flex justify-center gap-4">
                    <Button
                      size="lg"
                      className="bg-[var(--theme-primary)] text-black hover:bg-[var(--theme-primary-light)] font-bold text-lg px-8 py-6"
                    >
                    ...
                    <Button
                      size="lg"
                      variant="outline"
                      className="border-white/50 text-white hover:bg-white/10 hover:text-white font-bold text-lg px-8 py-6"
                    >
            ...
            <div className="mt-4 grid grid-cols-4 gap-2">
              {heroImages.map((img) => (
                <div
                  key={img.id}
                  className="aspect-video bg-black/20 rounded border-2 border-transparent hover:border-[var(--theme-primary)] cursor-pointer relative overflow-hidden group"
                >
                  {img.url ? (
