...
const tripPackages: TripPackage[] = [
  {
    ...
    description:
      "Experience the magic of ancient Egypt with a guided tour of the Pyramids of Giza, the Sphinx, and a luxurious Nile cruise from Luxor to Aswan visiting iconic temples.",
    price: 1299,
    originalPrice: 1599,
  ...
  },
  {
    ...
    description:
      "Relax on pristine beaches, explore vibrant coral reefs, and enjoy world-class diving in the crystal-clear waters of the Red Sea at a luxury beachfront resort.",
    price: 899,
    originalPrice: 1199,
  ...
  },
  {
    ...
    description:
      "Trek through the stunning Sinai desert landscape, climb Mount Sinai for a breathtaking sunrise, and discover the ancient St. Catherine's Monastery.",
    price: 699,
    originalPrice: 899,
  ...
  },
  {
    ...
    description:
      "Discover the pearl of the Mediterranean with visits to the ancient Library of Alexandria, Qaitbay Citadel, and enjoy fresh seafood along the stunning corniche.",
    price: 549,
    originalPrice: 749,
  ...
  },
  {
    ...
    description:
      "Indulge in the ultimate luxury beach vacation with an all-inclusive stay at a premium resort, private beach access, and exclusive water sports activities.",
    price: 1099,
    originalPrice: 1399,
  ...
  },
  {
    ...
    description:
      "Escape to the remote Siwa Oasis for a unique desert wellness retreat. Enjoy natural hot springs, ancient ruins, and the serenity of the Great Sand Sea.",
    price: 799,
    originalPrice: 999,
    duration: "5 Days / 4 Nights",
    rating: 4.8,
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center gap-4 text-xs text-white/50 font-[var(--font-body)]">
          <span className="flex items-center gap-1">
            <Clock size={12} className="text-[var(--theme-primary)]" />
            {pkg.duration}
          </span>
          <span className="flex items-center gap-1">
            <Star size={12} className="text-[var(--theme-primary)]" />
        ...
        <div className="flex items-center justify-between pt-3 border-t border-white/5">
          <div>
            <span className="text-white/30 text-xs line-through font-[var(--font-body)]">
              ${pkg.originalPrice}
            </span>
            <span className="text-[var(--theme-primary)] font-[var(--font-display)] text-2xl font-bold ml-2">
              ${pkg.price}
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="bg-[var(--theme-surface)] border border-white/8 rounded-lg overflow-hidden">
            <div className="relative h-64">
              ...
              <div className="absolute bottom-4 left-4">
                <h3 className="text-2xl font-[var(--font-display)] text-white">
                  {pkg.title}
                </h3>
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Highlights */}
              <div>
                <h4 className="text-sm uppercase tracking-wider text-[var(--theme-primary)] font-[var(--font-body)] mb-3">
                  Trip Highlights
                </h4>
                <div className="flex flex-wrap gap-2">
                  {pkg.highlights.map((h) => (
                    <span
                      key={h}
                      className="text-xs bg-[var(--theme-primary)]/10 text-[var(--theme-primary)] px-3 py-1.5 rounded-full font-[var(--font-body)] border border-white/10"
                    >
                      {h}
                    </span>
                  ))}
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {pkg.includes.map((inc) => (
                    <div
                      key={inc}
                      className="flex items-center gap-2 text-sm text-white/60 font-[var(--font-body)]"
                    >
                      <Check
                        size={14}
        ...
        <div className="lg:col-span-2">
          <div className="sticky top-28 bg-[var(--theme-surface)] border border-white/8 rounded-lg p-6 space-y-5">
            <h4 className="text-lg font-[var(--font-display)] text-white">
              Trip Configuration
            </h4>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-[var(--font-display)] text-xl w-8 text-center">
                  {bookingData.guests}
                </span>
                <button
                  onClick={() =>
                    setBookingData((p) => ({
                      ...p,
                      guests: Math.min(pkg.maxGuests, p.guests + 1),
                    }))
                  }
                  className="w-10 h-10 rounded bg-[var(--theme-surface)] border border-[var(--theme-primary)]/30 flex items-center justify-center text-[var(--theme-primary)] hover:bg-[var(--theme-primary)]/10 transition-colors"
                >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setBookingData((p) => ({ ...p, roomType: e.target.value }))
                }
                className="w-full bg-[var(--theme-surface)] border border-[var(--theme-primary)]/30 text-white px-4 py-3 rounded text-sm font-[var(--font-body)] focus:border-[var(--theme-primary)] focus:outline-none transition-colors"
              >
            ...
            <div className="pt-4 border-t border-white/5 space-y-3">
              <div className="flex justify-between text-sm">
                <span className="text-white/50 font-[var(--font-body)]">
                  Package ({bookingData.guests} guests)
                </span>
              ...
              <div className="flex justify-between pt-3 border-t border-white/5">
                <span className="text-white font-[var(--font-body)] font-semibold">
                  Total
                </span>
            ...
            <div className="flex items-center justify-center gap-4 pt-4 border-t border-white/5">
              {[
                ...
                <div
                  key={badge.label}
                  className="flex items-center gap-1 text-white/30 text-[10px]"
                >
                  <badge.icon
                    size={12}
      ...
      <div className="grid lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-3">
          <div className="bg-[var(--theme-surface)] border border-white/8 rounded-lg p-6 md:p-8 space-y-6">
            <h3 className="text-2xl font-[var(--font-display)] text-white mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookingData((p) => ({ ...p, firstName: e.target.value }))
                  }
                  placeholder="John"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookingData((p) => ({ ...p, lastName: e.target.value }))
                  }
                  placeholder="Doe"
                  className="w-full bg-[var(--theme-surface)] border border-[var(--theme-primary)]/30 text-white px-4 py-3 rounded text-sm font-[var(--font-body)] focus:border-[var(--theme-primary)] focus:outline-none transition-colors placeholder:text-white/20"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setBookingData((p) => ({ ...p, email: e.target.value }))
                  }
              ...
              <div className="md:col-span-2">
                <label className="text-white/70 text-xs uppercase tracking-wider font-[var(--font-body)] mb-2 flex items-center gap-2">
                  <Plane size={12} className="text-[var(--theme-primary)]" />{" "}
                  Nationality
                </label>
                <input
                  type="text"
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-white/50 text-xs font-[var(--font-body)] leading-relaxed group-hover:text-white/70 transition-colors">
                ...
                . I understand that my booking is subject to availability and
                confirmation by VANIR GROUP.
              </span>
            </label>
          ...
          <div className="sticky top-28 bg-[var(--theme-surface)] border border-white/8 rounded-lg p-6 space-y-5">
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute bottom-3 left-3">
                <p className="text-white text-sm font-[var(--font-display)] font-semibold">
                  {pkg.title}
                </p>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-white/5 space-y-2">
              ...
              {bookingData.roomType !== "standard" && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">
                    +${bookingData.roomType === "deluxe" ? 100 : 250}
                  </span>
                </div>
              )}
              <div className="flex justify-between pt-3 border-t border-white/5">
    ...
    try {
      ...
      const result = await createBookingMutation.mutateAsync({
        ...
        checkInDate: bookingData.departureDate
          ? new Date(bookingData.departureDate).getTime()
          : undefined,
            ...
            <div className="space-y-3">
              {paymentMethods.map((method) => (
                <button
                  key={method.id}
                  onClick={() =>
                    setPaymentData((p) => ({ ...p, method: method.id }))
                  }
                ...
                >
                  ...
                  <div className="flex-1">
                    <p
                      className={`font-[var(--font-body)] font-semibold text-sm ${
                        paymentData.method === method.id
                          ? "text-[var(--theme-primary)]"
                          : "text-white"
                      }`}
          ...
          <AnimatePresence mode="wait">
            {paymentData.method === "card" && (
              ...
              >
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          ...
                          boxShadow:
                            "0 20px 60px rgba(0,0,0,0.5), inset 0 1px 0 rgba(212,168,83,0.1)",
                        }}
                      >
                        {/* Top row */}
                        ...
                        <div className="flex justify-between items-end">
                          <div>
                            <p className="text-white/30 text-[9px] uppercase tracking-wider font-[var(--font-body)]">
                              Card Holder
                            </p>
                      ...
                      >
                        ...
                        <div className="px-6 mt-6">
                          <p className="text-white/20 text-[8px] font-[var(--font-body)] leading-relaxed">
                            This card is property of VANIR GROUP Banking
                            Services. Unauthorized use is prohibited. If found,
                ...
                <p className="text-center text-white/30 text-xs font-[var(--font-body)]">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
                      {cardBrand.brand && (
                        <span className="text-[var(--theme-primary)] text-xs font-[var(--font-body)] font-bold">
                          {cardBrand.brand}
                        </span>
                      )}
                      <Lock
                ...
                <div className="pt-4 border-t border-white/5">
                  <h5 className="text-sm font-[var(--font-body)] uppercase tracking-wider text-white/70 mb-4">
                    Billing Address
                  </h5>
            ...
            {paymentData.method === "paypal" && (
              ...
              >
                <div className="text-center py-8">
                  ...
                  <h4 className="text-xl font-[var(--font-display)] text-white mb-3">
                    Pay with PayPal
                  </h4>
                  <p className="text-white/50 text-sm font-[var(--font-body)] max-w-md mx-auto mb-6">
                    You will be redirected to PayPal to complete your payment
                    securely. After payment, you'll be returned to this page for
                    confirmation.
                  </p>
                  <div className="inline-flex items-center gap-2 bg-[var(--theme-primary)]/10 border border-white/10 rounded-lg px-4 py-2">
                    ...
                    <span className="text-[var(--theme-primary)] text-xs font-[var(--font-body)]">
            ...
            {paymentData.method === "bank" && (
              <motion.div
                ...
                className="bg-[var(--theme-surface)] border border-white/8 rounded-lg p-6 md:p-8"
              >
                <h4 className="text-lg font-[var(--font-display)] text-white mb-4">
                  Bank Transfer Details
                </h4>
                <p className="text-white/50 text-sm font-[var(--font-body)] mb-6">
                  Please transfer the total amount to the following bank
                  account. Your booking will be confirmed once we receive the
                  payment.
                </p>
                <div className="bg-[var(--theme-surface)] border border-white/10 rounded-lg p-5 space-y-4">
                  {[
                    ...
                    {
                      label: "IBAN",
                      value: "EG12 0003 0004 0000 1234 5678 901",
                    },
                    { label: "SWIFT Code", value: "NBEGEGCX" },
                    {
                      label: "Reference",
                      value: `VG-${Date.now().toString(36).toUpperCase().slice(0, 6)}`,
                    },
                  ].map((item) => (
                    <div
                      key={item.label}
                    ...
                    >
                      <span className="text-white/50 text-xs uppercase tracking-wider font-[var(--font-body)]">
                        {item.label}
                      </span>
            ...
            <div className="flex items-center gap-4">
              <div className="flex gap-2">
                {[Shield, Lock, BadgeCheck].map((Icon, i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-lg bg-[var(--theme-primary)]/10 flex items-center justify-center"
                  >
              ...
              <div>
                <p className="text-white text-sm font-[var(--font-body)] font-semibold">
                  Secure Payment
                </p>
                <p className="text-white/40 text-xs font-[var(--font-body)]">
          ...
          <div className="sticky top-28 space-y-6">
            <div className="bg-[var(--theme-surface)] border border-white/8 rounded-lg p-6 space-y-5">
              ...
              <div className="pt-4 border-t border-white/5 space-y-2">
                ...
                <div className="flex justify-between pt-3 border-t border-white/5">
                  <span className="text-white font-semibold">Total</span>
                  <span className="text-[var(--theme-primary)] font-[var(--font-display)] text-2xl font-bold">
                    ${totalPrice}
                  </span>
                </div>
              </div>
            ...
            <div className="bg-[var(--theme-surface)] border border-white/8 rounded-lg p-4">
              ...
              <div className="flex items-center gap-3">
                {["VISA", "MC", "AMEX", "PayPal"].map((card) => (
                  <div
                    key={card}
                    className="flex-1 bg-[var(--theme-surface)] border border-white/5 rounded py-2 text-center"
                  >
                    <span className="text-[var(--theme-primary)]/60 text-[10px] font-[var(--font-body)] font-bold">
                      {card}
                    </span>
                  </div>
                ))}
            ...
            <div className="bg-[var(--theme-primary)]/5 border border-white/10 rounded-lg p-4 flex items-start gap-3">
              <Shield
                size={20}
                className="text-[var(--theme-primary)] shrink-0 mt-0.5"
              />
              <div>
                <p className="text-white text-xs font-[var(--font-body)] font-semibold mb-1">
                  Money-Back Guarantee
                </p>
                <p className="text-white/40 text-[10px] font-[var(--font-body)] leading-relaxed">
                  Full refund if cancelled 48+ hours before departure. No
                  questions asked.
                </p>
              </div>
            </div>
...
function ConfirmationStep({
  ...
  const bookingRef =
    confirmationCode || `VG-${Date.now().toString(36).toUpperCase()}`;
  const totalPrice =
    pkg.price * bookingData.guests +
    (bookingData.roomType === "deluxe"
      ? 100
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12">
        ...
        >
          Your booking has been confirmed and payment processed. A confirmation
      ...
      >
        ...
        <div className="bg-[var(--theme-primary)]/10 border-b border-white/10 p-6 flex items-center justify-between">
          <div>
            <p className="text-[var(--theme-primary)] text-xs uppercase tracking-wider font-[var(--font-body)]">
              Booking Reference
            </p>
            <p className="text-white font-[var(--font-display)] text-2xl font-bold">
              {bookingRef}
            </p>
          </div>
        ...
        <div className="p-6 space-y-6">
          <div className="flex gap-4">
            <OptimizedImage
              ...
              containerClassName="w-24 h-24 rounded-lg shrink-0"
            />
            <div>
              <h4 className="font-[var(--font-display)] text-lg text-white">
                {pkg.title}
              </h4>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              {
                label: "Guests",
                value: `${bookingData.guests} person${bookingData.guests > 1 ? "s" : ""}`,
              },
              {
                label: "Room",
                value:
              ...
              <div
                key={item.label}
                className="bg-[var(--theme-surface)] rounded-lg p-4 text-center"
              >
                <p className="text-white/40 text-[10px] uppercase tracking-wider font-[var(--font-body)] mb-1">
                  {item.label}
                </p>
                <p className="text-[var(--theme-primary)] font-[var(--font-display)] font-bold">
                  {item.value}
                </p>
              </div>
            ))}
          ...
          <div className="bg-green-500/5 border border-green-500/20 rounded-lg p-5 flex items-start gap-4">
            ...
            <div>
              <h5 className="text-green-400 font-[var(--font-body)] font-semibold text-sm mb-1">
                Payment Confirmed
              </h5>
              <p className="text-white/50 text-xs font-[var(--font-body)] leading-relaxed">
                Your payment of{" "}
                ...
                has been successfully processed via {paymentMethodLabel}. A
                receipt and detailed itinerary have been sent to{" "}
                <span className="text-[var(--theme-primary)]">
                  {bookingData.email}
                </span>
                .
          ...
          <div className="bg-[var(--theme-primary)]/5 border border-white/10 rounded-lg p-5 flex items-start gap-4">
            ...
            <div>
              <h5 className="text-white font-[var(--font-body)] font-semibold text-sm mb-1">
                What's Next?
              </h5>
              <p className="text-white/50 text-xs font-[var(--font-body)] leading-relaxed">
                Our travel team will contact you within 24 hours with your
                detailed itinerary, visa requirements (if applicable), and
                pre-departure checklist. Check your inbox for the confirmation
                email.
              </p>
            </div>
          </div>
...
export default function Booking() {
  ...
  const [selectedPackage, setSelectedPackage] = useState<TripPackage | null>(
    null,
  );
    ...
    <div className="min-h-screen bg-[var(--theme-surface)]">
      ...
      <section className="relative h-[35vh] sm:h-[40vh] min-h-[250px] sm:min-h-[300px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img
            src="/manus-storage/hero-booking_ea711a1f.jpg"
            alt=""
            className="w-full h-full object-cover"
          />
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "Up to 48 hours before",
                },
                {
                  icon: Users,
                  title: "24/7 Support",
                  desc: "Expert travel assistance",
                },
              ].map((item, i) => (
                <motion.div
                  key={item.title}
                ...
                >
                  ...
                  />
                  <h4 className="text-white font-[var(--font-body)] font-semibold text-sm mb-1">
                    {item.title}
                  </h4>
                  <p className="text-white/40 text-xs font-[var(--font-body)]">
                    {item.desc}
