...
export default function Profile() {
  ...
  const [activeSection, setActiveSection] = useState<
    "overview" | "bookings" | "reviews" | "ai" | "settings"
  >("overview");
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Explore Egypt's wonders with VANIR Group. Your next
                        adventure awaits.
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-[var(--card)]/80 backdrop-blur-xl border border-[#2a2a3e] rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div
                        key={item.label}
                        className="flex items-center justify-between py-3 border-b border-[#2a2a3e]/50 last:border-0"
                      >
                ...
                {!userBookings || userBookings.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 text-sm">
                      Start your luxury travel journey with VANIR Group.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {userBookings.map((booking: any) => (
                      <div
                        key={booking.id}
                        className="flex items-center gap-4 p-4 bg-[#0d0d1a]/60 border border-[#2a2a3e] rounded-xl hover:border-[var(--theme-primary)]/20 transition-colors"
                      >
              ...
              <div className="bg-[var(--card)]/80 backdrop-blur-xl border border-[#2a2a3e] rounded-2xl p-6">
                ...
                {!userReviews || userReviews.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 text-sm">
                      Share your travel experience with the VANIR community.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {userReviews.map((review: any) => (
                      <div
                        key={review.id}
                        className="p-4 bg-[#0d0d1a]/60 border border-[#2a2a3e] rounded-xl hover:border-[var(--theme-primary)]/20 transition-colors"
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <div className="flex items-center gap-1">
                            {Array.from({ length: 5 }).map((_, i) => (
                              <Star
                                key={i}
                                className={`w-3.5 h-3.5 ${i < review.rating ? "text-[var(--theme-primary)] fill-[var(--theme-primary)]" : "text-gray-600"}`}
                              />
                            ))}
                          </div>
                        </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-1">
                        Email is managed through your login provider and cannot
                        be changed here.
                      </p>
                    </div>
                    <div>
                    ...
                    {[
                      {
                        ...
                        desc: "Receive booking confirmations and offers",
                        icon: Bell,
                      },
                      {
                        label: "Marketing Emails",
                        desc: "Get updates about new destinations and deals",
                        icon: Mail,
                      },
                      {
                        label: "Wishlist Alerts",
                        desc: "Notify when saved destinations have offers",
                        icon: Heart,
                      },
                    ].map((pref) => (
                      <div
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            toast.info("Preference settings coming soon!")
                          }
