...
class SDKServer {
  ...
  async verifySession(
    ...
    try {
      ...
      // Only openId is required — it is the user identity. appId and name are
      // informational metadata and may be empty (e.g. when VITE_APP_ID is unset
      // in production), so they must NOT cause the session to be rejected.
